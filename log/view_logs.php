...
/*
require_once '../../plugins/google-api-php-client/src/Google_Client.php';
require_once '../../plugins/google-api-php-client/src/contrib/Google_Oauth2Service.php';
session_start();

$client = new Google_Client();
$client->setApplicationName("RetroTax - FFQ");
$client->setClientId('931156433531.apps.googleusercontent.com'); 
$client->setClientSecret('YNP4SneDOyybX6Nd_nV8uNtY'); 
$client->setRedirectUri('https://ffq.retrotax.co/js/log/view_logs.php');
