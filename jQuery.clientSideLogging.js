...
(function($) {
	...
	var defaults = {
			error_url: '/js/log/?type=error',	// The url to which errors logs are sent
			info_url: '/js/log/?type=info',	// The url to which info logs are sent
			log_url: '/js/log/?type=log',		// The url to which standard logs are sent
